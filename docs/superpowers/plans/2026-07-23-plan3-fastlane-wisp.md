...
> Plan 5 resolution: wisp test harness ✅ (vitest), model:ready consumed ✅, downloads now range-resumable ✅, stt_failed wording done in plan2 ✅; symlink-validation + rhythm 25s-residual + repetition O(n) remain deliberate deferrals (trusted archive / defensible nudge / fine at 20-min scale). RESOLVED IN PLAN 5.
